...
export function InstitutionalDiagram({ locale }) {
  ...
  const globalDescription = locale === "fr" ? "Marque et écosystème international, sans statut juridique propre à ce jour" : "International brand and ecosystem, currently without legal status of its own";
